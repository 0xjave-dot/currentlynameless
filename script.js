...
const DEMO_REPORTS = [
  ...
  },
  {
    ...
    price: 5900,
    availability: 'in_stock',
    locationName: 'Ikorodu, Lagos',
    lga: 'Ikorodu',
    state: 'Lagos',
    sellerPlace: 'Ikorodu Main Market',
    lat: 6.6203,
    lng: 3.5128,
    timestamp: new Date(Date.now() - 70 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1514516870929-3cba2d1f257a?w=200&q=80',
  },
  {
    id: 'demo-11',
    itemName: 'Cooking Gas (12kg)',
    category: 'Household',
    price: 13500,
    availability: 'limited',
    ...
    lga: 'Obio-Akpor',
    state: 'Rivers',
    sellerPlace: 'Garden City Gas Depot',
    lat: 4.8390,
    lng: 7.0498,
    timestamp: new Date(Date.now() - 180 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1588535954092-e38e8878b38d?w=200&q=80',
  },
  {
    id: 'demo-12',
    itemName: 'Bread (Loaf)',
    ...
    price: 320,
    availability: 'in_stock',
    locationName: 'Keffi, Nasarawa',
    lga: 'Keffi',
    state: 'Nasarawa',
    sellerPlace: 'Central Bakery',
    lat: 8.7190,
    lng: 7.8750,
    timestamp: new Date(Date.now() - 45 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1560185127-6f8f1f3d3f77?w=200&q=80',
  },
  {
    id: 'demo-13',
    itemName: 'Seasoning Cubes (6-pack)',
    category: 'Groceries',
    price: 750,
    availability: 'in_stock',
    locationName: 'Aba, Abia',
    lga: 'Aba South',
    state: 'Abia',
    sellerPlace: 'Aba Spice Traders',
    lat: 5.1131,
    lng: 7.3600,
    timestamp: new Date(Date.now() - 80 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1559561857-7f43d8545fd7?w=200&q=80',
  },
  {
    id: 'demo-14',
    itemName: 'Loaf Bread (1 pack)',
    category: 'Groceries',
    price: 320,
    availability: 'in_stock',
    locationName: 'Jos, Plateau',
    lga: 'Jos North',
    state: 'Plateau',
    sellerPlace: 'Jos Street Bakery',
    lat: 9.8965,
    lng: 8.8583,
  ...
  },
  {
    ...
    price: 950,
    availability: 'in_stock',
    locationName: 'Onitsha, Anambra',
    lga: 'Onitsha North',
    state: 'Anambra',
    sellerPlace: 'Onitsha Market Square',
    lat: 6.1490,
    lng: 6.7853,
    timestamp: new Date(Date.now() - 120 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1580910051070-5fd67c0db0d6?w=200&q=80',
  },
  {
    id: 'demo-16',
    itemName: 'Soap (Pack)',
    ...
    price: 620,
    availability: 'in_stock',
    locationName: 'Awka, Anambra',
    lga: 'Awka South',
    state: 'Anambra',
    sellerPlace: 'Awka Mall',
    lat: 6.2100,
    lng: 7.0713,
    timestamp: new Date(Date.now() - 85 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1581075724371-2b6bb3ab9db5?w=200&q=80',
  },
  {
    id: 'demo-17',
    itemName: 'Groundnut Oil (1L)',
    category: 'Groceries',
    price: 1250,
    availability: 'limited',
    locationName: 'Aba, Abia',
  ...
  {
    id: 'demo-18',
    itemName: 'Yam Tubers (Per tuber)',
    category: 'Food',
    price: 1350,
    availability: 'in_stock',
    locationName: 'Uyo, Akwa Ibom',
    lga: 'Uruan',
    state: 'Akwa Ibom',
    sellerPlace: 'Uyo Market',
    lat: 5.0493,
    lng: 7.9072,
    timestamp: new Date(Date.now() - 300 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1508747703725-719f61a0e76c?w=200&q=80',
  },
  {
    id: 'demo-19',
    ...
    price: 5200,
    availability: 'limited',
    locationName: 'Ilorin, Kwara',
    lga: 'Ilorin West',
    state: 'Kwara',
    sellerPlace: 'Ilorin Building Supplies',
    lat: 8.4900,
    lng: 4.5421,
  ...
  },
  {
    ...
    price: 1800,
    availability: 'in_stock',
    locationName: 'Maiduguri, Borno',
    lga: 'Maiduguri Metropolitan',
    state: 'Borno',
    sellerPlace: 'Maiduguri Retail Hub',
    lat: 11.8333,
    lng: 13.1500,
    timestamp: new Date(Date.now() - 90 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1516146373284-30b6e1d48356?w=200&q=80',
  },
  {
    id: 'demo-21',
    itemName: 'Milo (500g)',
    ...
    lga: 'Jos North',
    state: 'Plateau',
    sellerPlace: 'Jos Supermart',
    lat: 9.8965,
    lng: 8.8583,
    timestamp: new Date(Date.now() - 50 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1516685018646-54921d5f79b3?w=200&q=80',
  },
  {
    id: 'demo-22',
    itemName: 'Rice (25kg)',
    ...
    price: 14500,
    availability: 'in_stock',
    locationName: 'Oshogbo, Osun',
    lga: 'Osogbo',
    state: 'Osun',
    sellerPlace: 'Osogbo Rice Depot',
    lat: 7.7764,
    lng: 4.5695,
    timestamp: new Date(Date.now() - 130 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1458642849426-cfb724f15ef7?w=200&q=80',
  },
  {
    id: 'demo-23',
    itemName: 'Fuel (5 Liter)',
    category: 'Fuel',
    price: 3850,
    availability: 'limited',
    locationName: 'Ilorin, Kwara',
  ...
  },
  {
    ...
    lga: 'Owerri North',
    state: 'Imo',
    sellerPlace: 'Owerri Market',
    lat: 5.4884,
    lng: 7.0357,
    timestamp: new Date(Date.now() - 75 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1523986371872-9d3ba2e2f7d9?w=200&q=80',
  },
  {
    id: 'demo-25',
    itemName: 'Chair (Plastic)',
    category: 'Household',
    price: 1400,
    availability: 'in_stock',
    locationName: 'Umuahia, Abia',
    lga: 'Umuahia North',
    state: 'Abia',
    sellerPlace: 'Umuahia Household Store',
    lat: 5.5248,
    lng: 7.4946,
    timestamp: new Date(Date.now() - 250 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1519710164239-da123dc03ef4?w=200&q=80',
  },
  {
    id: 'demo-26',
    itemName: 'Electricity Prepaid Card',
    category: 'Utilities',
    price: 2000,
    availability: 'in_stock',
    locationName: 'Asaba, Delta',
    lga: 'Asaba',
    state: 'Delta',
    sellerPlace: 'Asaba Utility Shop',
    lat: 6.2060,
    lng: 6.7973,
    timestamp: new Date(Date.now() - 110 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1512446733611-9099a758e8e5?w=200&q=80',
  },
  {
    id: 'demo-27',
    itemName: 'Mobile Data Bundle',
    category: 'Utilities',
    price: 1800,
    availability: 'in_stock',
    locationName: 'Ibadan, Oyo',
    lga: 'Ibadan North',
    state: 'Oyo',
    sellerPlace: 'Ibadan Tech Hub',
    lat: 7.3775,
    lng: 3.9470,
    timestamp: new Date(Date.now() - 42 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=200&q=80',
  },
  {
    id: 'demo-28',
    itemName: 'Fresh Fish (per kg)',
    category: 'Food',
    price: 3400,
    availability: 'in_stock',
    locationName: 'Calabar, Cross River',
    lga: 'Calabar Municipal',
    state: 'Cross River',
    sellerPlace: 'Calabar Fish Market',
    lat: 4.9578,
    lng: 8.3265,
  ...
  },
  {
    ...
    price: 450,
    availability: 'limited',
    locationName: 'Sokoto, Sokoto',
    lga: 'Sokoto North',
    state: 'Sokoto',
    sellerPlace: 'Sokoto Market',
    lat: 13.0068,
    lng: 5.2435,
    timestamp: new Date(Date.now() - 140 * 60 * 1000).toISOString(),
    imageUrl: 'https://images.unsplash.com/photo-1525755662778-989d0524087e?w=200&q=80',
  },
];
  ...
  return `
    <article id="report-card-${escHtml(r.id)}" class="report-card grid-card" data-idx="${idx}">
      ...
      <div style="display:flex;justify-content:flex-end;margin-top:12px;">
        <button class="btn btn-ghost btn-sm" type="button" onclick="openListingModal('${escHtml(r.id)}')">View listing</button>
      </div>
    </article>`;
}
...
function openListingModal(reportId) {
  ...
  body.innerHTML = `
    ...
    <div class="listing-actions" style="display:flex;gap:8px;margin-top:8px;flex-wrap:wrap;align-items:center;">
    ...
    <button class="btn btn-primary listing-add-to-cart" type="button" onclick="addToShoppingList('${report.id}'); toast('Added to cart', 'success');">Add to cart</button>
    <div class="listing-info-row">
      <div>
        <span class="listing-info-label">Seller</span>
        <div class="listing-info-value">${escHtml(report.sellerPlace || report.userName || report.posterName || report.userEmail || 'Anonymous')}</div>
      </div>
      <div>
        <span class="listing-info-label">Exact location</span>
        <div class="listing-info-value">${escHtml([report.locationName, report.lga, report.state].filter(Boolean).join(', ') || 'Unknown')}</div>
      </div>
    </div>
